...
export function UserSessionBar({ user }: { user: SessionUser }) {
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3">
      <Link
        href="/"
        className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--card)] px-3 py-2 text-xs font-medium text-[var(--c-blue-800)] shadow-sm transition hover:border-[var(--c-gold-400)] hover:text-[var(--c-blue-950)]"
